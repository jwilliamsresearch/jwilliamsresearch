...
<div style="background: linear-gradient(to right, #201040, #102040); padding: 20px; border-radius: 10px;">
<h2 style="color: white; font-family: sans-serif; border-bottom: 1px solid #444;">🔬 Research & Open Structure</h2>
<p style="color: #ddd; font-family: sans-serif;">
...
<div style="background: linear-gradient(to right, #102040, #001020); padding: 20px; border-radius: 10px;">
...
<div align="center" id="connect" style="background: rgba(255,255,255,0.05); padding: 15px; border-radius: 50px;">
